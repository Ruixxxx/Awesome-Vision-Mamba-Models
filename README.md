...
| ICLR 2025 | MambaQuant: Quantizing the Mamba Family with Variance Aligned Rotation Methods | [Link](https://openreview.net/forum?id=KI45uDnmzv) | [Code](https://github.com/mambaquant/mambaquant) | Quantization |
...
| Medical Image Analysis 2025 | MambaMIM: Pre-training Mamba with State Space Token Interpolation | [Link](https://doi.org/10.1016/j.media.2025.103606) | [Code](https://github.com/FengheTan9/MambaMIM) | Medical Image Pre-training |
...
| IEEE RA-L | MambaXCTrack: Mamba-based Tracker with SSM Cross-correlation and Kalman Smoother for Ultrasound Needle Tracking | [Link](https://arxiv.org/abs/2411.08395) |  | Ultrasound Needle Tracking |
...
| ICCV 2025 | Snakes and Ladders: Two Steps Up for VideoMamba | [Link](https://openaccess.thecvf.com/content/ICCV2025/html/Lu_Snakes_and_Ladders_Two_Steps_Up_for_VideoMamba_ICCV_2025_paper.html) | [Code](https://github.com/hotfinda/videomambapro) | Video Understanding |
...
| IEEE RA-L | OMEGA: Efficient Occlusion-Aware Navigation for Air-Ground Robot in Dynamic Environments via State Space Model | [Link](https://arxiv.org/abs/2408.10618) |  | Robot Navigation |
